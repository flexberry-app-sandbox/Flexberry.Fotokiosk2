...
namespace IIS.Fotokiosk2
{
    ...
    [View("КлиентE", new string[] {
            ...
            "Оплата.СделатьФото.ИнфоФото.Цена as \'Стоимость\'",
            "Оплата.Дата as \'Дата\'",
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk2.Оплата fОплата;
        
        private IIS.Fotokiosk2.ОтправНаПочту fОтправНаПочту;
        ...
        [PropertyStorage(new string[] {
                "Оплата"})]
        [NotNull()]
        public virtual IIS.Fotokiosk2.Оплата Оплата
        {
            get
            {
                ...
                IIS.Fotokiosk2.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "ОтправНаПочту"})]
        [NotNull()]
        public virtual IIS.Fotokiosk2.ОтправНаПочту ОтправНаПочту
        {
            get
            {
                ...
                IIS.Fotokiosk2.ОтправНаПочту result = this.fОтправНаПочту;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Fotokiosk2.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Fotokiosk2.Клиент));
                }
            }
        }
    }
