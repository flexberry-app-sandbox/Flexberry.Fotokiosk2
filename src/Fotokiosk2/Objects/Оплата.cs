...
namespace IIS.Fotokiosk2
{
    ...
    [View("ОплатаE", new string[] {
            ...
            "Дата as \'Дата\'",
            "Время as \'Время\'",
            "СделатьФото.ИнфоФото.Категория as \'Категория фото\'",
            "СделатьФото.КолВоФото as \'Количество фото\'",
            "СделатьФото.ИнфоФото.Цена as \'Стоимость\'"})]
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk2.ВидОплаты fСпособОпл;
        
        private System.DateTime fДата;
        
        private string fВремя;
        
        private IIS.Fotokiosk2.СделатьФото fСделатьФото;
        ...
        public virtual IIS.Fotokiosk2.ВидОплаты СпособОпл
        {
            get
            {
                ...
                IIS.Fotokiosk2.ВидОплаты result = this.fСпособОпл;
        ...
        [PropertyStorage(new string[] {
                "СделатьФото"})]
        [NotNull()]
        public virtual IIS.Fotokiosk2.СделатьФото СделатьФото
        {
            get
            {
                ...
                IIS.Fotokiosk2.СделатьФото result = this.fСделатьФото;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Fotokiosk2.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Fotokiosk2.Оплата));
                }
            }
        }
    }
